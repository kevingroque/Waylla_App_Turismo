...
public class MisPostsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mis_posts, container, false);
        ...
        mCrearPostFab = (FloatingActionButton) view.findViewById(R.id.mypost_fab_agregar);
        mPostListRecycler = (RecyclerView) view.findViewById(R.id.mypost_recycler_postlist);
        ...
        CollectionReference mispostref = mFirestore.collection("posts");

        Query firstQuery = mispostref.whereEqualTo("user_uid", user_uid);
