...
import com.roque.app.waylla_app.adapters.ChatAdapter;
import com.roque.app.waylla_app.models.Message;
import com.roque.app.waylla_app.utils.ClickListener;
import com.roque.app.waylla_app.utils.RecyclerTouchListener;
import com.roque.app.waylla_app.utils.SpeakerLabelsDiarization;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend = (ImageButton) findViewById(R.id.chatbot_btn_send);
        btnRecord= (ImageButton) findViewById(R.id.chatbot_btn_record);
        String customFont = "Montserrat-Regular.ttf";
        Typeface typeface = Typeface.createFromAsset(getAssets(), customFont);
        inputMessage.setTypeface(typeface);
        recyclerView = (RecyclerView) findViewById(R.id.chatbot_recycler_view);
